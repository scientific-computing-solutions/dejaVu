...
test_that("negative_binomial",{
  ...
  expect_true(ks.test(CreateSamples(p=0.5,gamma=1,N=10000),"pnbinom",size=1,prob=0.5)$p.value<0.05)
  expect_true(ks.test(CreateSamples(p=0.25,gamma=1.3,N=10000,Ti=50),"pnbinom",size=1.3,prob=0.25)$p.value<0.05)
  expect_true(ks.test(CreateSamples(p=0.15,gamma=0.8,N=10000),"pnbinom",size=0.8,prob=0.15)$p.value<0.05)
