...
source(paste(path,"/Code/cim_v1.4.R", sep=""))
...
sasname=paste(path,"/Data/PSIposter1_type1.csv",sep="")
lstname=paste(path,"/Data/PSIposter1_type1.rds",sep="")
ptime <- system.time({
poster1 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0,T=1,
			    ...
			    meth2=c("complete","dl","j2r","tr","delta"),delta=1.5)
})[3]
ptime
...
sasname=paste(path,"/Data/PSIposter2_type1.csv",sep="")
lstname=paste(path,"/Data/PSIposter2_type1.rds",sep="")
ptime <- system.time({
poster2 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0,T=1,
                             dispersion.placebo=0.9,dispersion.treatment=0.9,
                             rates=drates,drop_rate_variance=0.05,
                             N.rep=nr,N.mi=10,alpha=0.04,1,sasname,meth=c("nbd"), 
				     meth2=c("complete","dl","j2r","tr","delta"),delta=1.5)
...
sasname=paste(path,"/Data/PSIposter3_type1.csv",sep="")
lstname=paste(path,"/Data/PSIposter3_type1.rds",sep="")
ptime <- system.time({
poster3 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0,T=1,
                             dispersion.placebo=0.9,dispersion.treatment=0.9,
                             rates=drates,drop_rate_variance=0.05,
                             N.rep=nr,N.mi=10,alpha=0.04,1,sasname,meth=c("nbd"), 
				     meth2=c("complete","dl","j2r","tr","delta"),delta=1.5)
...
sasname=paste(path,"/Data/PSIposter4_type1.csv",sep="")
lstname=paste(path,"/Data/PSIposter4_type1.rds",sep="")
ptime <- system.time({
poster4 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0,T=1,
                             dispersion.placebo=0.9,dispersion.treatment=0.9,
                             rates=drates,drop_rate_variance=0.05,
                             N.rep=nr,N.mi=10,alpha=0.04,1,sasname,meth=c("nbd"), 
				     meth2=c("complete","dl","j2r","tr","delta"),delta=1.5)
...
sasname=paste(path,"/Data/PSIposter5_type1.csv",sep="")
lstname=paste(path,"/Data/PSIposter5_type1.rds",sep="")
ptime <- system.time({
poster5 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0,T=1,
                             dispersion.placebo=0.9,dispersion.treatment=0.9,
                             rates=drates,drop_rate_variance=0.05,
                             N.rep=nr,N.mi=10,alpha=0.04,1,sasname,meth=c("nbd"), 
				     meth2=c("complete","dl","j2r","tr","delta"),delta=1.5)
...
sasname=paste(path,"/Data/PSIposter6_type1.csv",sep="")
lstname=paste(path,"/Data/PSIposter6_type1.rds",sep="")
ptime <- system.time({
poster6 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0,T=1,
                             dispersion.placebo=0.9,dispersion.treatment=0.9,
                             rates=drates,drop_rate_variance=0.05,
                             N.rep=nr,N.mi=10,alpha=0.04,1,sasname,meth=c("nbd"), 
				     meth2=c("complete","dl","j2r","tr","delta"),delta=1.5)
