...
sasname=paste(path,"/Data/PSIposter1ld.csv",sep="")
lstname=paste(path,"/Data/PSIposter1ld.rds",sep="")
ptime <- system.time({
poster1 <- sim_mar2_mc(n=228,rate.placebo=0.88,rr=0.4,T=1,
			    ...
			    meth2=c("complete","dl","j2r","tr","delta"),delta=1.4)
})[3]
ptime
...
sasname=paste(path,"/Data/PSIposter2ld.csv",sep="")
lstname=paste(path,"/Data/PSIposter2ld.rds",sep="")
ptime <- system.time({
...
sasname=paste(path,"/Data/PSIposter3ld.csv",sep="")
lstname=paste(path,"/Data/PSIposter3ld.rds",sep="")
ptime <- system.time({
...
sasname=paste(path,"/Data/PSIposter4ld.csv",sep="")
lstname=paste(path,"/Data/PSIposter4ld.rds",sep="")
ptime <- system.time({
...
sasname=paste(path,"/Data/PSIposter5ld.csv",sep="")
lstname=paste(path,"/Data/PSIposter5ld.rds",sep="")
ptime <- system.time({
...
sasname=paste(path,"/Data/PSIposter6ld.csv",sep="")
lstname=paste(path,"/Data/PSIposter6ld.rds",sep="")
ptime <- system.time({
